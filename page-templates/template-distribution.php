	...
	<main id="main" class="site-main" role="main">
		...
		<section id="distribution-hero" class="distribution-section">
			<div class="container text-center">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/yellow-flower.png" alt="Flor Amarilla" class="yellow-flower">
				<h1 class="display-4">Distribución de Tortillas</h1>
				<div class="hero-layer-green-container">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/hero-layer-green.png" alt="Capa Verde" class="hero-layer-green">
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 text-center">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/flowers-cross-layer.png" alt="Adorno Floral" class="img-fluid">
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 production-item">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/maiz-item.png" alt="Maíz o Trigo">
						<p>En maíz o trigo</p>
					</div>
					<div class="col-md-4 production-item">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tortillas-item.png" alt="Tamaño de Tortillas">
						<p>Del tamaño<br>que necesites</p>
					</div>
					<div class="col-md-4 production-item">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tortilla-item.png" alt="Grosor de Tortilla">
