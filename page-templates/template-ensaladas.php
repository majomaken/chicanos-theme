            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="combo-image-placeholder">
                        <img src="https://via.placeholder.com/400x300" alt="Ensalada placeholder" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-6">
                    <h1 class="combo-main-title">Ensaladas</h1>
                    <p class="combo-description">
                        Personaliza tu ensalada con nuestras frescas opciones
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="combo-content-main">
            ...
            <form id="combo-builder-form" class="combo-builder">
                ...
                if ($ensalada_product_id) {
                    $product = wc_get_product($ensalada_product_id);
                    if ($product) {
                        ...
                        $wapf_data = get_post_meta($ensalada_product_id, '_wapf_fieldgroup', true);
                        ...
                        if (!empty($wapf_data) && isset($wapf_data['fields'])) {
                            ...
                            echo '<!-- DEBUG: Producto ID: ' . $ensalada_product_id . ' -->';
                            echo '<!-- DEBUG: Meta fields disponibles: ' . print_r(get_post_meta($ensalada_product_id), true) . ' -->';
                        }
                    ...
                    echo '<p>No se seleccionó ningún producto de ensalada.</p>';
                }
                ?>
